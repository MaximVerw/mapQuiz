...
class SelectionDialog(QWidget):
    def __init__(self):
        ...
        self.diff5_button = QPushButton("Blandijn - Boekentoren")
        self.diff5_button.clicked.connect(self.diff5_selected)
        self.layout.addWidget(self.diff5_button)
    ...
    def launch_app(self, option):
        ...
        if option == 1:
            ...
            area_of_interest_wkt = 'POLYGON((3.7175846099853516 51.0427497940874,3.720717430114746 51.04111731746039,3.7241613864898686 51.03924866823593,3.7253308296203618 51.03866849466078,3.72612476348877 51.0385065844595,3.729504346847534 51.038452614266646,3.7294936180114746 51.03877643448064,3.729161024093628 51.03945779878981,3.7294399738311768 51.04025383548887,3.729000091552734 51.04211569842843,3.7284743785858154 51.04423381383069,3.728570938110351 51.04630461647005,3.7288713455200195 51.04787620619325,3.729279041290283 51.048800249076436,3.7295472621917725 51.04942750855818,3.729032278060913 51.04984567682658,3.7284636497497554 51.0497917198428,3.7276482582092285 51.049521933981055,3.726242780685425 51.04948146596624,3.724654912948608 51.04944099791609,3.723206520080566 51.049319593553435,3.72009515762329 51.04907678387346,3.720041513442993 51.048179725961774,3.720749616622925 51.046837479046275,3.721007108688355 51.04579872860509,3.7209320068359375 51.04468575585429,3.720738887786865 51.044200086637176,3.719977140426635 51.04370092130253,3.7187218666076656 51.04312080348012,3.7175846099853516 51.0427497940874))'
